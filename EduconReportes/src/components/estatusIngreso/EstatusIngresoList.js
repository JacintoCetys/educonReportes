...
export const EstatusIngresoList = ({ padronData, isLoading }) => {
  ...
  const columns = [
    ...
    { name: 'Matricula', label: 'Matrícula', options: { filter: false, sort: true } },
    { name: 'Nombre_Abr', label: 'Abreviado', options: { filter: false, sort: true } },
    ...
    { name: 'Direccion_Alu', label: 'Dirección', options: { filter: false, sort: true } },
    { name: 'Colonia_Alu', label: 'Colonia', options: { filter: false, sort: true } },
    { name: 'Telefono_Alu', label: 'Teléfono', options: { filter: false, sort: true } },
    { name: 'Telefono_Celular_Alu', label: 'Celular', options: { filter: false, sort: true } },
    { name: 'Email_Alumno', label: 'Correo-e', options: { filter: false, sort: true } },
    { name: 'Correo_Institucional_Alumno', label: 'Correo-e Institucional', options: { filter: false, sort: true } },
    { name: 'Sexo', options: { filter: true, sort: true } },
    { name: 'Fecha_Nacimiento', label: 'Fecha Nacimiento', options: { filter: false, sort: true, customBodyRender: value => moment(new Date(value)).format("DD-MM-YYYY") } },
    ...
    { name: 'Empresa_Padre', label: 'Empresa', options: { filter: false, sort: true } },
  ];
